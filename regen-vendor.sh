...
VENDOR_SKIP_FILES=(
    ...
    "etc/aoc/HEADSET.dat"
    "etc/aoc/downlink_bluetooth_headset_config.pb"
    "etc/aoc/downlink_dock_config.pb"
    "etc/aoc/downlink_external_speaker_config.pb"
    "etc/aoc/downlink_handset_config.pb"
    "etc/aoc/downlink_speaker_config.pb"
    "etc/aoc/downlink_wired_headset_config.pb"
    "etc/aoc/mcps.dat"
    "etc/aoc/recording.gatf"
    "etc/aoc/smartfeature.gstf"
    "etc/aoc/uplink_bluetooth_headset_aec_off_config.pb"
    "etc/aoc/uplink_bluetooth_headset_aec_on_config.pb"
    "etc/aoc/uplink_dock_aec_off_config.pb"
    "etc/aoc/uplink_dock_aec_on_config.pb"
    "etc/aoc/uplink_external_speaker_aec_off_config.pb"
    "etc/aoc/uplink_external_speaker_aec_on_config.pb"
    "etc/aoc/uplink_handset_aec_off_config.pb"
    "etc/aoc/uplink_handset_aec_on_config.pb"
    "etc/aoc/uplink_speaker_aec_off_config.pb"
    "etc/aoc/uplink_speaker_aec_on_config.pb"
    "etc/aoc/uplink_wired_headset_aec_off_config.pb"
    "etc/aoc/uplink_wired_headset_aec_on_config.pb"
    ...
    # Overlays
    "overlay/DeviceDiagnostics__tangorpro__auto_generated_rro_vendor.apk"
